...
// Make changes to MAVLocation.m instead.

#import "_MAVLocation.h"

const struct MAVLocationAttributes MAVLocationAttributes = {
	.address = @"address",
	.latitude = @"latitude",
	.longitude = @"longitude",
};

const struct MAVLocationRelationships MAVLocationRelationships = {
	.annotations = @"annotations",
};

@implementation MAVLocationID
@end

@implementation _MAVLocation
...
- (MAVLocationID*)objectID {
	return (MAVLocationID*)[super objectID];
}
